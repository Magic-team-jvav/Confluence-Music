...
public final class CMJukeboxSongs {
    ...
    public static final ResourceKey<JukeboxSong> ALT_OVERWORLD_NIGHT = ResourceKey.create(Registries.JUKEBOX_SONG, ConfluenceMusic.asResource("alt_overworld_night"));
    ...
    public static final ResourceKey<JukeboxSong> DUNGEON_FLOOR_1 = ResourceKey.create(Registries.JUKEBOX_SONG, ConfluenceMusic.asResource("dungeon_floor_1"));
    public static final ResourceKey<JukeboxSong> DUNGEON_FLOOR_2 = ResourceKey.create(Registries.JUKEBOX_SONG, ConfluenceMusic.asResource("dungeon_floor_2"));
    ...
    public static final ResourceKey<JukeboxSong> BLIZZARD = ResourceKey.create(Registries.JUKEBOX_SONG, ConfluenceMusic.asResource("blizzard"));
    ...
    public static void boostrap(BootstrapContext<JukeboxSong> context) {
        ...
        register(context, OVERWORLD_NIGHT, CMSoundEvents.OVERWORLD_NIGHT, 124, 1);
        register(context, ALT_OVERWORLD_NIGHT, CMSoundEvents.ALT_OVERWORLD_NIGHT, 188, 1);
        ...
        register(context, DESERT, CMSoundEvents.DESERT, 150, 1);
        register(context, UNDERGROUND_DESERT, CMSoundEvents.UNDERGROUND_DESERT, 1, 1);
        register(context, OCEAN_DAY, CMSoundEvents.OCEAN_DAY, 115, 1);
        register(context, OCEAN_NIGHT, CMSoundEvents.OCEAN_NIGHT, 1, 1);
        register(context, SPACE_DAY, CMSoundEvents.SPACE_DAY, 128, 1);
        register(context, SPACE_NIGHT, CMSoundEvents.SPACE_NIGHT, 124, 1);
        register(context, UNDERGROUND, CMSoundEvents.UNDERGROUND, 141, 1);
        register(context, ALT_UNDERGROUND, CMSoundEvents.ALT_UNDERGROUND, 232, 1);
        register(context, MUSHROOMS, CMSoundEvents.MUSHROOMS, 116, 1);
        register(context, JUNGLE, CMSoundEvents.JUNGLE, 121, 1);
        register(context, JUNGLE_NIGHT, CMSoundEvents.JUNGLE_NIGHT, 119, 1);
        register(context, UNDERGROUND_JUNGLE, CMSoundEvents.UNDERGROUND_JUNGLE, 1, 1);
        register(context, CORRUPTION, CMSoundEvents.CORRUPTION, 114, 1);
        register(context, UNDERGROUND_CORRUPTION, CMSoundEvents.UNDERGROUND_CORRUPTION, 120, 1);
        register(context, CRIMSON, CMSoundEvents.CRIMSON, 100, 1);
        register(context, UNDERGROUND_CRIMSON, CMSoundEvents.UNDERGROUND_CRIMSON, 164, 1);
        register(context, THE_HALLOW, CMSoundEvents.THE_HALLOW, 126, 1);
        ...
        register(context, DUNGEON_FLOOR_1, CMSoundEvents.DUNGEON_FLOOR_1, 137, 1);
        register(context, DUNGEON_FLOOR_2, CMSoundEvents.DUNGEON_FLOOR_2, 120, 1);
        ...
        register(context, TOWN_NIGHT, CMSoundEvents.TOWN_NIGHT, 108, 1);
        register(context, BOSS_1, CMSoundEvents.BOSS_1, 153, 1);
        ...
        register(context, SANDSTORM, CMSoundEvents.SANDSTORM, 134, 1);
        register(context, BLIZZARD, CMSoundEvents.BLIZZARD, 138, 1);
        ...
        register(context, MORNING_RAIN, CMSoundEvents.MORNING_RAIN, 260, 1);
        register(context, STORM, CMSoundEvents.STORM, 1, 1);
        register(context, OTHERWORLDLY_RAIN, CMSoundEvents.OTHERWORLDLY_RAIN, 94, 1);
        register(context, OTHERWORLDLY_OVERWORLD_DAY, CMSoundEvents.OTHERWORLDLY_OVERWORLD_DAY, 92, 1);
        register(context, OTHERWORLDLY_NIGHT, CMSoundEvents.OTHERWORLDLY_NIGHT, 90, 1);
        register(context, OTHERWORLDLY_UNDERGROUND, CMSoundEvents.OTHERWORLDLY_UNDERGROUND, 87, 1);
        register(context, OTHERWORLDLY_DESERT, CMSoundEvents.OTHERWORLDLY_DESERT, 95, 1);
        register(context, OTHERWORLDLY_OCEAN, CMSoundEvents.OTHERWORLDLY_OCEAN, 101, 1);
        register(context, OTHERWORLDLY_MUSHROOMS, CMSoundEvents.OTHERWORLDLY_MUSHROOMS, 96, 1);
        register(context, OTHERWORLDLY_JUNGLE, CMSoundEvents.OTHERWORLDLY_JUNGLE, 89, 1);
        register(context, OTHERWORLDLY_DUNGEON, CMSoundEvents.OTHERWORLDLY_DUNGEON, 90, 1);
        register(context, OTHERWORLDLY_SPACE, CMSoundEvents.OTHERWORLDLY_SPACE, 111, 1);
        register(context, OTHERWORLDLY_UNDERWORLD, CMSoundEvents.OTHERWORLDLY_UNDERWORLD, 92, 1);
        register(context, OTHERWORLDLY_SNOW, CMSoundEvents.OTHERWORLDLY_SNOW, 90, 1);
        register(context, OTHERWORLDLY_ICE, CMSoundEvents.OTHERWORLDLY_ICE, 91, 1);
        register(context, OTHERWORLDLY_CORRUPTION, CMSoundEvents.OTHERWORLDLY_CORRUPTION, 91, 1);
        register(context, OTHERWORLDLY_UNDERGROUND_CORRUPTION, CMSoundEvents.OTHERWORLDLY_UNDERGROUND_CORRUPTION, 91, 1);
        register(context, OTHERWORLDLY_CRIMSON, CMSoundEvents.OTHERWORLDLY_CRIMSON, 100, 1);
        register(context, OTHERWORLDLY_UNDERGROUND_CRIMSON, CMSoundEvents.OTHERWORLDLY_UNDERGROUND_CRIMSON, 105, 1);
        register(context, OTHERWORLDLY_HALLOW, CMSoundEvents.OTHERWORLDLY_HALLOW, 131, 1);
        register(context, OTHERWORLDLY_UNDERGROUND_HALLOW, CMSoundEvents.OTHERWORLDLY_UNDERGROUND_HALLOW, 92, 1);
        register(context, OTHERWORLDLY_EERIE, CMSoundEvents.OTHERWORLDLY_EERIE, 91, 1);
        register(context, OTHERWORLDLY_BOSS_1, CMSoundEvents.OTHERWORLDLY_BOSS_1, 92, 1);
        register(context, OTHERWORLDLY_BOSS_2, CMSoundEvents.OTHERWORLDLY_BOSS_2, 100, 1);
        register(context, OTHERWORLDLY_INVASION, CMSoundEvents.OTHERWORLDLY_INVASION, 92, 1);
        register(context, OTHERWORLDLY_THE_TOWERS, CMSoundEvents.OTHERWORLDLY_THE_TOWERS, 87, 1);
        register(context, OTHERWORLDLY_LUNAR_BOSS, CMSoundEvents.OTHERWORLDLY_LUNAR_BOSS, 85, 1);
        register(context, OTHERWORLDLY_PLANTERA, CMSoundEvents.OTHERWORLDLY_PLANTERA, 91, 1);
        register(context, OTHERWORLDLY_WALL_OF_FLESH, CMSoundEvents.OTHERWORLDLY_WALL_OF_FLESH, 77, 1);
    }
