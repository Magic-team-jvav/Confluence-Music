...
public class CMBlocks {
    ...
    public static final Supplier<MusicBoxBlock> MUSIC_BOX_OTHERWORLD_DAY = register("music_box_otherworld_day", CMMusics.OVERWORLD_DAY);
    // todo eerie
    public static final Supplier<MusicBoxBlock> MUSIC_BOX_NIGHT = register("music_box_night", CMMusics.OVERWORLD_NIGHT);
    // todo title
    public static final Supplier<MusicBoxBlock> MUSIC_BOX_UNDERGROUND = register("music_box_underground", CMMusics.UNDERGROUND);
    // todo boss1
    public static final Supplier<MusicBoxBlock> MUSIC_BOX_JUNGLE = register("music_box_jungle", CMMusics.JUNGLE);
    public static final Supplier<MusicBoxBlock> MUSIC_BOX_CORRUPTION = register("music_box_corruption", CMMusics.CORRUPTION);
    public static final Supplier<MusicBoxBlock> MUSIC_BOX_UNDERGROUND_CORRUPTION = register("music_box_underground_corruption", CMMusics.UNDERGROUND_CORRUPTION);
    public static final Supplier<MusicBoxBlock> MUSIC_BOX_THE_HALLOW = register("music_box_the_hallow", CMMusics.HALLOW);
    // todo boss2
    public static final Supplier<MusicBoxBlock> MUSIC_BOX_UNDERGROUND_HALLOW = register("music_box_underground_hallow", CMMusics.UNDERGROUND_HALLOW);
    // todo boss3
