...
public final class CMBlocks {
    ...
    public static final DeferredBlock<MusicBoxBlock> MUSIC_BOX_NIGHT = register("music_box_night", CMMusics.OVERWORLD_NIGHT);
    ...
    public static final DeferredBlock<MusicBoxBlock> MUSIC_BOX_LUNAR_BOSS = register("music_box_lunar_boss", CMMusics.MOON_LORD);
    ...
    public static final DeferredBlock<MusicBoxBlock> MUSIC_BOX_GOBLIN_INVASION = register("music_box_goblin_invasion", CMMusics.GOBLIN_ARMY);
